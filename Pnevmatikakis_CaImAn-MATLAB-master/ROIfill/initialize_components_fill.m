function [Ain, Cin, bin, fin, center] = initialize_components_fill(Y, A, options, P)
...
[Ain, Cin, bin, fin] = greedyROI_fill(Y_ds, A, options);




%  
%  %%% this should be changed - need only one option!
